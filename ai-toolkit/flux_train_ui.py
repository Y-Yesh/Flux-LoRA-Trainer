...
def start_training(
    ...
    config["config"]["process"][0]["datasets"][0]["folder_path"] = destination_folder
...
""", elem_classes="group_padding")
    ...
    #start_0.click(fn=create_dataset, inputs=[images] + caption_list, outputs=dataset_folder, api_name='start_training0')
    ...
    do_captioning.click(fn=run_captioning, inputs=[images, concept_sentence] + caption_list, outputs=caption_list, api_name="Do Captioning")
